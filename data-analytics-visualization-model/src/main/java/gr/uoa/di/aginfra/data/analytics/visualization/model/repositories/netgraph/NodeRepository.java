...
public interface NodeRepository extends Neo4jRepository<Node, Long> {
    ...
    @Query("MATCH (n:Node) -[n1:HAS_DATENODE]-()-[hw:HAS_WEIGHT]-()-[n2:HAS_DATENODE]-(nf)-[h:HAS_PROPERTY]-(p:NodeProperty) " +
            "where n.subGraphId={0} and n.nodeId={1} return  collect(distinct nf),h,p,hw")
