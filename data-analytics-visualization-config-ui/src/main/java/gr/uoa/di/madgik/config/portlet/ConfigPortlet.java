package gr.uoa.di.madgik.config.portlet;
...
import gr.uoa.di.madgik.config.endpoint.EndpointManager;
...
public class ConfigPortlet extends GenericPortlet {
	...
	private static Logger logger = LoggerFactory.getLogger(ConfigPortlet.class);
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse) throws IOException, PortletException {
		logger.info("Configuration portlet is rendering the main view");
	...
	public int doRequest(String endpoint, ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws IOException {
		...
		try {
			...
			logger.info("Connection response:" + status);
			...
			if (!isOKStatus(status)) {
				...
				logger.info("Back end service returned with status " + status + ": " + connection.getContentLength() + " bytes");
